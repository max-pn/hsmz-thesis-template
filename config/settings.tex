%
% @file           settings.tex 
% @description    Shared configuration file for thesis and exposé pdf. 
%
...
\soulregister\gls7
\soulregister\chapterwordcount7
...
\AtBeginDocument{%
	\renewcommand{\sectionautorefname}{\sectionreflabel} %  TODO: set desired ref label in metadata.tex
	\renewcommand{\subsectionautorefname}{\subsectionreflabel} %  TODO: set desired ref label in metadata.tex
}
...
% Captions
\DeclareCaptionFont{apa-caption-font}{\fontsize{11pt}{14pt}\selectfont}
...
\newglossarystyle{hsmz-acronyms}{                                     % custom style for acronyms 
	...
	{\begin{longtable}{@{}p{3cm}p{\dimexpr\linewidth-2.5cm\relax}@{}}}  %  TODO: adjust spacing if necessary 
	{\end{longtable}}
}
...
\newglossarystyle{hsmz-glossary}{                                     % custom style for glossaries
	...
	\renewcommand*{\glspostdescription}{}                               % - no punctuation after glossary descriptions
	\renewenvironment{theglossary}                                      % - 2-column style
	{\begin{longtable}{@{}p{4cm}p{\dimexpr\linewidth-2.5cm\relax}@{}}}  %  TODO: adjust spacing if necessary
	{\end{longtable}}
}

\glsaddkey{alternative}%
{}%
{\glsentryalternative}%
{\Glsentryalternative}%
{\glsalternative}%
...
% Wordcount macro for chapters
\usepackage{currfile}
\usepackage{catchfile}
\usepackage{shellesc}

\input{config/wordcountchapter.tex}
